...
if __name__ == "__main__":
    main(ipus_table="csvs/ipus_uba.csv", output_folder="tracks", output_list="lists/tracks.lst", corpus="uba", config="/Users/jazsneider/Downloads/Debug/configs/experiments.ini", tracks_extraction_config="/Users/jazsneider/Downloads/Debug/configs/tracks_extraction.ini", tasks_table="csvs/tasks_uba.csv", force=True)