...
if __name__ == "__main__":
    main(output_fname="csvs/ipus_uba.csv", config="/Users/jazsneider/Downloads/Debug/configs/experiments.ini", corpus="uba", tasks_table="csvs/tasks_uba.csv", subjects_info_csv='csvs/subjects_info_uba.csv', force=True)
