...
def process_instance(idx, fname_metadata, columns_static, static_features_to_use, features_combination, time_interval, config, series_type, columns_temporal):
    ...
    speaker_1_channel = metadata["speaker_1_channel"]
    ...
    x_i = np.concatenate([x_i, [speaker_1_channel]])
    x_i_cols = np.concatenate([x_i_cols, ["speaker_1_channel"]])
...
if __name__ == "__main__":
    ...
    main(instances_list="lists/dev_instances_overlap.lst", output_folder = "X_Y/overlap/dev", features_config="/Users/jazsneider/Downloads/Debug/configs/features.ini", combination="IPU+SUBJ+TEMP+TURN", time_interval="both", series_type="raw", n_jobs=3, force=True)
    main(instances_list="lists/dev_instances_no_overlap.lst", output_folder = "X_Y/no_overlap/dev", features_config="/Users/jazsneider/Downloads/Debug/configs/features.ini", combination="IPU+SUBJ+TEMP+TURN", time_interval="both", series_type="raw", n_jobs=3, force=True)
